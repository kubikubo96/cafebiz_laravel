    ...
    <div class="container" style="margin-top: 0px;">
        <div class="row">
            <div class="col-md-9 c1" style=" ">
                <h4 class="c2" style="">
                    <a href="detail/{{$hotnews->id}}/{{$hotnews->title_link}}.html" style="text-decoration: none;color: black;"><b>{{$hotnews->title}}</b>
                    </a>
                </h4>
                <div class="row" style="margin: 0">
                    ...
                    <div class="col-md-4 c6 c61" style="">
                        ...
                        <h6><a style="color: black;text-decoration: none;" href="detail/{{$ht->id}}/{{$ht->title_link}}.html">{{$ht->title}}</a></h6>
                    </div>
                    @endforeach
                    <div class="row">
                        @foreach($post as $pt)
                        ...
                        <div class="col-7 c7">
                            <h4><a style="text-decoration: none;color: #000000;" href="detail/{{$pt->id}}/{{$pt->title_link}}.html">{{$pt->title}}</a></h4>
