            ...
            <div class="row">
                <div class="col-md-9 c1">
                    <div class="panel panel-default" style="border: 1px solid #dddddd; border-radius: 0px 0px 10px 10px; ">
                        <div class="panel-heading" style="font-weight: bold;padding: 10px; background-color: #a4a4a4; ">Đăng ký tài khoản</div>
                        <div class="panel-body" style="padding: 15px;">
                            ...
                            <form action="register" method="post">
                                ...
                                <div>
                                    ...
                                    <input type="password" class="form-control confirm_password" name="confirm_password" aria-describedby="basic-addon1">
                                </div>
                                <br>
