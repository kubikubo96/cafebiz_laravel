            ...
            <div class="row">
                <div class="col-md-9 c1">
                    <div class="panel panel-default" style="border: 1px solid #dddddd; border-radius: 0px 0px 10px 10px; ">
                        <div class="panel-heading" style="font-weight: bold;padding: 10px; background-color: #a4a4a4; ">Thông tin tài khoản</div>
                        <div class="panel-body" style="padding: 15px;">
                            ...
                            <form action="pages/appcrud/edit/{{$user->id}}" method="post">
                                ...
                                <div>
                                    <label>Họ tên</label>
                                    <input type="text" class="form-control" value="{{$user->name}}" name="name" placeholder="Họ tên" aria-describedby="basic-addon1">
                                </div>
                                <br>
                                <div>
                                    <label>Email</label>
                                    <input type="email" name="email" class="form-control" value="{{$user->email}}" readonly placeholder="Email" aria-describedby="basic-addon1"
                                    >
                                </div>
                                <br>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="password" disabled class="form-control confirm_password" name="confirm_password" aria-describedby="basic-addon1">
                                </div>
                                <br>
