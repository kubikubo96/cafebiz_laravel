...
<div class="logo">
    <a href="index.html">
        <img src="admin_asset/pages/img/logo-big.png" alt=""/> </a>
</div>
<!-- END LOGO -->
<!-- BEGIN LOGIN -->
<div class="content">
<!-- BEGIN LOGIN FORM -->
    ...
    <form class="login-form" role="form" action="admin/login" method="POST">
        ...
        <div class="form-group">
            ...
            <label class="control-label visible-ie8 visible-ie9" for="inputEmail">Email</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="email" autocomplete="off"
                   placeholder="Email address" id="inputEmail" name="email"/></div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9" for="inputPassword">Password</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" id="inputPassword" autocomplete="off"
...
<div class="copyright"> 2019 © Admin BossVn</div>
<!--[if lt IE 9]>
